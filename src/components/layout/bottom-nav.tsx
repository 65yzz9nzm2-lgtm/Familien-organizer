...
export function BottomNav() {
  ...
  return (
    <>
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-30 flex items-center justify-around border-t border-border bg-card/95 py-2 backdrop-blur lg:hidden print:hidden">
        {primary.map((item) => (
          <NavLink
            key={item.href}
            to={item.href}
